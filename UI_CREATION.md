# Interface Prompt Creation Instructions

We want to generate an INTERFACE creation prompt using a FITTING design style from the available list, or choose your own style if you identify something more suitable that's not listed.

# Purpose of landing page

[Purpose Here as user shared with Agent]

# Available Design Styles (not limited to these - feel free to identify and use other professional styles, picked by user.)

DO NOT default to Neobrutalist or any particular favorite. Actually select the most fitting design for the purpose.
...
After selecting a design style (either from the list or your own professional choice), create a Interface prompt that is EXACTLY THREE PARAGRAPHS. Focus intensely on conveying the FEELING and ATMOSPHERE of the chosen style:

## Paragraph 1

State the chosen style(s) and instruct the AI to create an innovative business/service concept for a the desired purpose. Describe the core emotional qualities and feeling this style evokes - what mood should visitors experience as they arrive? How should the visual hierarchy and flow make them feel as they scroll through this single cohesive page? Include a note to incorporate colorful elements as appropriate to enhance the design's emotional impact.

## Paragraph 2

Explain the design philosophy through the lens of emotion and user experience. How should typography feel - authoritative, welcoming, cutting-edge? What sensation should interactions and animations create - smooth and liquid, snappy and precise, gentle and organic? Describe how each page’s journey should emotionally progress from first impression through final call-to-action, creating a complete narrative arc in each scrolling experience.
...
The generated prompt must emphasize that is each PAGE of the UI created is part of a single scrolling experience. Focus on feeling, atmosphere, and abstract quality references rather than technical details or specific examples. Keep all references conceptual and high-level to allow for maximum creative interpretation.
